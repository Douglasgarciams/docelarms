...
def upload_to_b2(file_obj, object_name):
    # ... (código da função upload_to_b2 com marca d'água continua aqui, sem alterações) ...
    # (Copie a função completa da mensagem anterior aqui)
    ...
    try:
        ...
        if font:
            ...
            print(f"Desenhando marca d'água em ({x},{y})")
